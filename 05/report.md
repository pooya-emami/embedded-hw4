...
The test session validates the results of the History API:

#### Right Panel - Server Compilation and Startup (Top)
...
#### Right Panel - Test Suite Execution (Bottom)
...
#### Left Panel - Network Activity Monitoring 
